...
let failed = 0;
for (const t of ['tools/calls.mjs', 'tools/boot.mjs', 'tools/audio.mjs', 'tools/soak.mjs', 'tools/render.mjs', 'tools/tutorial.mjs', 'tools/controls.mjs', 'tools/playthrough.mjs']) {
  console.log(`\n===== ${t} =====`);
